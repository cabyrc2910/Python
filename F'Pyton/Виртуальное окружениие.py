...
pip install -U pip setuptools # U-сокращенно upgrade, далее следуют имя или имена модулей, которые требуется обновить, в данном случае setuptools
python.exe -m pip install -U pip setuptools #- тоже самое
pip install request lxml #- установка библиотек requests и lxml - если нужно установить несколько библиотек, то командой  pip uninstall lxml #- можно перечислить их через пробел, - lxml - удаление библиотеки
