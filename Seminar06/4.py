###########################################################################################
# Функция принимает строки "Имя Фамилия" возвращает словарь, где ключ первая буква фамилии,
#  затем первая буква имени и массив имён соответсвующий первым буквам
############################################################################################
